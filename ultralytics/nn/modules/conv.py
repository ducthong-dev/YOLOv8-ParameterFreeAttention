...
class SimAM(nn.Module):
    ...
    A parameter-free attention module that computes 3D attention weights based on spatial energy function.
    Unlike channel or spatial attention modules, SimAM requires no learnable parameters.
    
    Reference: Yang, L., Zhang, R. Y., Li, L., & Xie, X. (2021). SimAM: A Simple, Parameter-Free Attention Module for Convolutional Neural Networks.
    
    Args:
        e_lambda: Regularization parameter for energy function, default is 1e-4
    """
