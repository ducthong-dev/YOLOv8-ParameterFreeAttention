...
from ultralytics.nn.modules import (AIFI, C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C2f_HPC_Lite,
                                    C3Ghost, C3x, Classify, Concat, Conv, Conv2, ConvTranspose, Detect, DWConv, DWConvTranspose2d,
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 BottleneckCSP, C1, C2, C2f, C2f_HPC_Lite, C3, C3TR, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x, RepC3,
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C2f_HPC_Lite, C3, C3TR, C3Ghost, C3x, RepC3):
            ...
            # SimAM is parameter-free, doesn't need c1 or c2
            # args can be [] for default e_lambda=1e-4, or [e_lambda] to customize
            c2 = ch[f]  # Output channels same as input
            args = args if args else []  # Use provided args or empty list for defaults

        elif m is SSC:
            # SSC is parameter-free and preserves channel count.
            c2 = ch[f]
